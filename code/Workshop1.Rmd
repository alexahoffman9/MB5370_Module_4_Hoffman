...
```
Another warning!!
Question: When would using alpha (or size be appropriate??) In a dense point cloud where you can see clusters a bit better.
...
```
Warning: G2;H2;Warningh: [38;5;232mThe shape palette can deal with a maximum of 6 discrete values because more than 6 becomes difficult to discriminate [36mℹ[38;5;232m you have requested 7 values. Consider specifying shapes manually if you need that many of them.
